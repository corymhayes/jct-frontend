...
/* harmony import */ var _components_MobileLayout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("6XN1");
/* harmony import */ var _components_Details__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("A0tZ");
/* harmony import */ var _components_FullDetails__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("Xf2F");
...
const Home = ({
  data,
  isMobileView
}) => isMobileView ? __jsx(_components_MobileLayout__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
  company_name: "Mammoth",
  site_name: "CEH",
  date: data[0].mDate,
  time: `${data[0].mTime.substr(0, 4)} ${data[0].mTime.substr(-2)}`
}, __jsx(_components_FullDetails__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
  name: data[0].S1,
  ...
  alarmOn: data[0].V5,
  alarmOff: data[0].V6
}), __jsx(_components_Details__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
  name: data[0].S3,
