...
const DoughnutChart = props => {
  ...
  })), DoughnutChart_jsx(Volume, null, DoughnutChart_jsx(CurrentVolume, null, props.currentValue !== null ? props.currentValue.toFixed(2) : props.currentValue), DoughnutChart_jsx(CurrentVolumeLabel, null, "Volume")));
};
...
const Alarms = props => Alarms_jsx(Container, null, Alarms_jsx(Title, null, "Alarms"), Alarms_jsx(AlarmList, null, Alarms_jsx(AlarmListItem, null, "On: ", props.on !== null ? props.on.toFixed(2) : props.on), Alarms_jsx(AlarmListItem, null, "Off: ", props.off !== null ? props.off.toFixed(2) : props.off)));
